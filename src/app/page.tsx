        ...
        <MaxWidthWrapper className="pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52">
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              <div className="absolute w-28 left-0 -top-32 hidden lg:block">
                <img
                  src="/custom_phone.png"
                  className="w-full"
                  alt="decorative"
                />
              </div>
              <h1 className="relative w-fit tracking-tight text-balance mt-16 font-bold !leading-tight text-5xl md:text-6xl lg:text-7xl">
                ...
                <span className="px-2">Unique</span> Phone Case
              </h1>
              <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap text-gray-700">
                Design your personalized phone case to showcase your style.{" "}
                <span className="font-semibold">Stand out</span> with a
                one-of-a-kind accessory.
              </p>

              <ul className="mt-8 space-y-2 text-left font-medium flex flex-col items-center sm:items-start text-gray-700">
              ...
              <div className="mt-12 flex flex-col sm:flex-row items-center sm:items-start gap-5">
                <div className="flex -space-x-4">
                  <img
                    className="inline-block h-10 w-10 rounded-full ring-2 ring-blue-100"
                  ...
                  />
                  <img
                    className="inline-block object-cover h-10 w-10 rounded-full ring-2 ring-blue-100"
      ...
      <section className="bg-slate-100 grainy-dark py-24">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
            ...
            <img src="/phone-2.png" className="w-24 order-0 lg:order-2" />
          </div>
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="flex gap-4 mt-2">
                ...
                <div className="flex flex-col">
                  <p className="font-semibold">Bishwash</p>
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  "मेरो फोन केस प्रायः निकै चाँडै
                  चर्किन्छ। तर, यो केसले मेरो अपेक्षालाई पार गरेको छ—{" "}
                  <span className="p-0.5 bg-slate-800 text-white">
                    लगभग छ महिना पछि पनि यो उत्कृष्ट अवस्थामा छ
                  </span>
                  , केवल एक कोनामा थोरै खरोंच मात्र छ। एकदम टिकाउ!" यसको टिकाउपन र राम्रो गुणस्तरले मलाई निकै प्रभावित बनाएको छ।
                </p>
              </div>
              <div className="flex gap-4 mt-2">
                <img
                ...
                />
                <div className="flex flex-col">
                  <p className="font-semibold">Smriti</p>
                  <div className="flex gap-1.5 items-center text-zinc-600">
                    <Check className="h-4 w-4 stroke-[3px] text-red-600" />
                    <p className="text-sm">Verified Purchase</p>
                  </div>
        ...
        <MaxWidthWrapper className="py-24">
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-40">
              ...
              <Phone className="w-60" imgSrc="/rohit.jpg" />
            </div>
          </div>
